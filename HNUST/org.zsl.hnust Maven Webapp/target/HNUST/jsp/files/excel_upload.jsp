...
<body>
	<h2> <font size=8>班级成绩上传</font></h2>
	<p><font size=6>Class achievement upload.</font></p>
	<div style="margin:20px 0;"></div>
	<form id="upload" name="upload" action="${pageContext.request.contextPath }/upload_excel.action" method="post" enctype="multipart/form-data" style="margin:10% 70% 50% 30%;">
	<div class="easyui-panel" title="上传文件" style="width:600px;padding:30px 70px 50px 70px;">
		<div style="margin-bottom:30px">
			<div><font size=8>File1:</font></div>
			<!-- <input class="easyui-filebox" name="file" data-options="prompt:'Choose a excel..'" style="width:100%;height:100px"> -->
			<input class="easyui-filebox" name="file"  style="width:100%;height:100px"> 
		</div>
