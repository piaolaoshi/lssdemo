...
<body>
	...
	<c:if test="${result.equals('modifyTeacher')}">
		...
		<c:if test="${result.equals('insertTeacher')||result.equals('modifyTeacher')}">
					<div style="margin-bottom:20px">
			...
			<input name="power" class="easyui-textbox"  style="width:100%;height:32px;" value="${user_modify.power}">
		</div>
		</c:if>
			<div>
			<a onclick="add.submit()" class="easyui-linkbutton" iconCls="icon-ok" style="width:100%;height:70px">Register</a>
		</div>
		</form>
	</div>
	</div>
